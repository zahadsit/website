...
const page = () => {
  ...
  const service = taxation.find((service) => service.id === slug);
          ...
          {service.services.map((item, index) => (
            ...
            >
              <div className="w-full md:w-1/2 shrink-0 px-8 md:px-16 py-10 md:py-20">
                <h2 className="text-2xl md:text-3xl mt-3 font-mont border-l-4 pl-2 border-primary">
                  {item.title}
                </h2>
                <p className="mt-4 tracking-wide text-gray-500 text-sm md:text-base font-light">
                  {item.description}
                </p>
              </div>
