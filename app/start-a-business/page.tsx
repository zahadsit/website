    ...
    return (
        <div>
            <ServiceHero
                ...
                costCalculator
                description='It’s no secret that Dubai offers business owners countless benefits, the biggest ones being 0% income tax and a central, strategic location. If you are curious about how to start a business in Dubai, Zahads uses a time-tested process to get your idea to market as soon as possible'
                showButton
